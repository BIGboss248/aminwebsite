...
import DohErrorBoundary from "./error";
...
describe("DoH ErrorBoundary Component", () => {
  ...
  it("renders error UI and triggers reset on click", () => {
    ...
    const testError = new Error("Test anomaly in DoH route segment");

    render(<DohErrorBoundary error={testError} reset={mockReset} />);
  ...
  it("renders error digest when present", () => {
    ...
    expect(screen.getByText("DOH_ERR_4081")).toBeInTheDocument();
  });
});
