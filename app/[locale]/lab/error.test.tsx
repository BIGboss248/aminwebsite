...
import LabErrorBoundary from "./error";
...
describe("Lab ErrorBoundary Component", () => {
  ...
  it("renders error UI and triggers reset on click", () => {
    ...
    const testError = new Error("Test anomaly in lab route segment");

    render(<LabErrorBoundary error={testError} reset={mockReset} />);
  ...
  it("renders error digest when present", () => {
    ...
    expect(screen.getByText("LAB_ERR_9012")).toBeInTheDocument();
  });
});
